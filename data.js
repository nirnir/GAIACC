...
export const actionQueue = [
  {
    id: "HIT-7810",
    title: "Sensor anomaly verification",
    summary: "Predictive Maintenance flagged repeated vibration spikes on two chillers—needs facilities confirmation before restart.",
    status: "escalated",
    sla: "00:45",
    businessUnit: "Facilities Ops",
    workflowId: "AUTO-004",
  ...
  {
    id: "HIT-7794",
    title: "Bid package compliance review",
    summary: "Contract Bidding Support encountered missing legal annexes for a federal RFP submission.",
    status: "investigating",
    sla: "02:30",
    businessUnit: "Strategic Accounts",
    workflowId: "AUTO-009",
    workflow: "Contract Bidding Support",
    urgency: "critical",
  },
  {
    id: "HIT-7752",
    title: "Order throttling approval",
    summary: "Order Routing & Capacity Management suggests pausing two sites due to downstream cold chain capacity.",
    status: "pending",
    sla: "01:10",
    businessUnit: "Network Operations",
    workflowId: "AUTO-003",
    workflow: "Order Routing & Capacity Management",
    urgency: "high",
  },
  {
    id: "HIT-7721",
    title: "Executive summary refresh",
    summary: "Contract Copilot requests updated financial narrative before briefing CFO.",
    status: "pending",
    sla: "03:40",
    businessUnit: "Executive Advisory",
    workflowId: "COP-203",
    workflow: "Contract Copilot",
    urgency: "medium",
  },
  {
    id: "HIT-7688",
    title: "Weekly adoption review",
    summary: "Operations Copilot closed the week without escalations—review highlights and archive.",
    status: "completed",
    sla: "--",
    businessUnit: "Field Excellence",
    workflowId: "COP-201",
    workflow: "Operations Copilot",
    urgency: "low",
  },
];
